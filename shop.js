 ...
 function initMAXRegistration(){
   ...
   const startGate=()=>{
     ...
     if(cached&&current){
       ...
       // Refresh the profile silently. A fresh MAX initData is still required by the server.
